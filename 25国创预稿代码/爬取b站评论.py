...
# 创建文件
folder_path = r'AI眼镜视频评论/Bilibili'
file_path = os.path.join(folder_path, f'B站ai眼镜评论数据10.csv')
...
web='https://www.bilibili.com/video/BV1bXJwzWEfZ'
...
for page in range(1,52):
    ...
    for index in comments:
        ...
        dit = {
            '标题':"49g AI+AR智能眼镜！探访Rokid Glasses目前怎么样？",
